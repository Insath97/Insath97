...
![Location](https://img.shields.io/badge/📍-Sri_Lanka-2C9CDB?style=for-the-badge)
![Role](https://img.shields.io/badge/🛠️-Backend_Engineer-FF9900?style=for-the-badge)
![Pronouns](https://img.shields.io/badge/😄-He%2FHim-7B2FF7?style=for-the-badge)
![Status](https://img.shields.io/badge/💞️-Open_to_Collaborate-00C7B7?style=for-the-badge)

[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/mohamed-insath90a40724a)
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:insath1997.mi@gmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Insath97)
...
I'm a **backend engineer** who designs and ships APIs and systems in **Laravel, Node.js, and FastAPI** — and I'm just as comfortable taking a feature all the way to the frontend in **React / Next.js** when a project needs it. I ship through **Docker**-based, cloud-native pipelines on **AWS** and **GCP**.

```ts
type Insath = {
  role: "Backend Engineer";
  backendCore: ["Laravel (PHP)", "Node.js", "Express.js", "FastAPI (Python)", "Java", "C#"];
  frontendCapable: ["React.js", "Next.js", "Tailwind CSS", "Angular.js"];
...
- 💞️ Open to collaborating on **API-driven, backend-heavy, and cloud-native projects**
...
![Languages](https://img.shields.io/badge/LANGUAGES-E34F26?style=for-the-badge)
...
![Backend](https://img.shields.io/badge/BACKEND_%26_APIS-2496ED?style=for-the-badge)
...
![Frontend](https://img.shields.io/badge/FRONTEND-61DAFB?style=for-the-badge&logoColor=black)
...
![API Types](https://img.shields.io/badge/API_TYPES_%26_TOOLS-E10098?style=for-the-badge)
...
![Cloud](https://img.shields.io/badge/CLOUD%2C_DEVOPS_%26_HOSTING-FF9900?style=for-the-badge)
...
![Tools](https://img.shields.io/badge/TOOLS_%26_WORKFLOW-7B2FF7?style=for-the-badge)
...
![Gaming](https://img.shields.io/badge/🎮_GAMING-107C10?style=for-the-badge)
...
|---|---|---|
| **[Project Name]** | Laravel · MySQL · Docker | One-line outcome-focused description — what it does and who it's for. |
| **[Project Name]** | Next.js · Node.js · MongoDB | One-line outcome-focused description. |
| **[Project Name]** | FastAPI · PostgreSQL · Redis · AWS | One-line outcome-focused description. |

</div>

> 💡 Swap the placeholders above for 3–4 of your strongest repos, and pin them on your actual GitHub profile too.
