...
[![LinkedIn](https://img.shields.io/badge/-Mohamed_Insath-0077B5?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/mohamed-insath90a40724a)
...
I'm a full-stack engineer who works comfortably across the entire stack — from relational and document databases, through backend services in **PHP, Node.js, and Python**, to modern frontends in **React and Next.js** — and ships it all through **Docker**-based, cloud-native pipelines.

```ts
type Insath = {
  role: "Full-Stack Engineer";
  backend: ["Laravel (PHP)", "Node.js", "Express.js", "FastAPI (Python)", "Java", "C#"];
...
> 💡 Swap the placeholders above for 3–4 of your strongest repos — pin them on your actual GitHub profile too, since pinned repos carry more weight than this table for recruiters skimming your page.
